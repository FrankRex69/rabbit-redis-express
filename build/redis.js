...
export const startLong = async (longUrl, account) => {
    try {
        // Create keyRedis
        let keyRedis = longUrl + "_" + account;
        // Connection Redis
...
export const startShort = async (shortUrl) => {
    try {
        // Connection Redis
        await clientRedis.connectRedis();
        ...
        if (checkRedis.longUrl) {
            ...
            let nrequestRedisUpdate = ++checkRedis.count;
